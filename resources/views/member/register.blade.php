    ...
    <div class="grid md:grid-cols-12 font-poppins relative pb-20 pt-8 mx-auto max-w-screen overflow-hidden">
        ...
        <div class="col-span-12 col-start-1 lg:col-start-2 xl:col-start-4">
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[15px] flex flex-col items-center gap-5 px-3">
                    ...
                    <!-- Form login -->
                    <section class="w-11/12 max-w-[460px] -mt-6">
                        <form action="{{route('member.register.store')}}" method="POST" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            ...
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Your complete name" name="name" id="name" value="{{old('name')}}" />
                                    @error('name')
                            ...
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="email"
                                    class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream"
                                    placeholder="Your email address" name="email" id="email" value="{{old('email')}}"/>
                                      @error('email')
                                        <div style="color: red">{{$message}}</div>
                                    @enderror
                            </div>
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="text"
                                    class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream"
                                    placeholder="Your complete Phone Number" name="phone_number" id="phone_number" value="{{old('phone_number')}}" />
                                    @error('phone_number')
                                        <div style="color: red">{{$message}}</div>
                                    @enderror
                            </div>
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="password"
                                    ...
                                    placeholder="Your password" name="password" id="password" value="{{old('password')}}" />
                                      @error('password')
                                        <div style="color: red">{{$message}}</div>
                                    @enderror
                            </div>
