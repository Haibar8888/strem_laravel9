...
@section('title-desc','Our selected movies for your moods')
          ...
          <div class="flex gap-14 items-start">
            ...
            <div class="flex flex-col gap-10">
              ...
              <div class="w-full relative overflow-hidden group">
                <img
                  src="{{asset("stream/assets/images/featured-2.png")}}"
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-stream-gray text-base mt-[6px]">
                   {{$movie->categories}} - {{date('Y',strtotime($movie->release_date))}}
                  </p>
                </div>
                <div class="inline-flex items-center gap-[6px]">
                  ...
                  <img src="{{asset("stream/assets/images/ic_star.svg")}}" alt="" />
                  <img src="{{asset("stream/assets/images/ic_star.svg")}}" alt="" />
                  <div class="text-base text-white ml-[6px] mt-1">18,049</div>
                </div>
              </div>
              ...
              <div>
                ...
                <p
                  class="max-w-[700px] mt-[10px] text-stream-gray text-base leading-8"
                >
                 {{$movie->about}}
                </p>
              </div>
